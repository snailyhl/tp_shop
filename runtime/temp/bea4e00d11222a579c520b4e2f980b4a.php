<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"F:\www\local.shop\public/../application/home\view\goods\detail.html";i:1533814444;s:58:"F:\www\local.shop\application\home\view\public\topNav.html";i:1533975102;}*/ ?>
...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：
				<a href="/">首页</a>
				<?php foreach ( $parentCats as $v ) : ?>
			 	> <a href="<?php url('/home/category/index', ['cat_id' => $v['cat_id']]); ?>"><?php echo $v['cat_name'] ?></a>
			 	<?php endforeach; ?>
			...
			<div class="summary">
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="" method="post" class="choose">
						<ul>
							<?php foreach($singleAttrs as $v) : ?>
							<li class="product">
								<dl>
									<dt><?php echo $v[0]['attr_name']; ?></dt>
									<dd>
										<?php foreach($v as $k => $attr) : ?>
										<a <?php echo $k == 0? 'class="selected"' : ''; ?> href="javascript:;"><?php echo $attr['attr_value'] . ' &nbsp;&nbsp; &yen;' . $attr['attr_price']; ?> <input type="radio" name="color" value="<?php echo $attr['goods_attr_id']; ?>" checked="checked" /></a>
										<?php endforeach; ?>
	...
	<script type="text/javascript">
		...
		$('#addCart').click(function () {
			...
			// 获取class=selected 下面的input元素, 即获取到所有选中的元素
