<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\www\local.shop\public/../application/home\view\cart\orderaccount.html";i:1533954751;s:58:"F:\www\local.shop\application\home\view\public\topNav.html";i:1533975102;}*/ ?>
...
<body>
	...
	<div class="fillin w990 bc mt15">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td class="col3">￥ <?php echo $danjian; ?></td>
		...
		<div class="fillin_ft">
			...
			<p>应付总额：<strong>￥<?php echo $totalPrice; ?></strong></p>
...
<script>
	$('#orderPay').click(function () {
		// console.log( $("form[name='address_form']").submit() );
