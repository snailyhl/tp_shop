<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"F:\www\local.shop\public/../application/home\view\category\index.html";i:1533726184;s:58:"F:\www\local.shop\application\home\view\public\topNav.html";i:1533975102;}*/ ?>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>当前位置：
				...
				<?php foreach($parentCats as $cat) : ?>
					> <a href="<?php echo url('/home/category/index', ['cat_id' => $cat['cat_id']]); ?>">
		...
		<div class="list_left fl mt10">
			...
			<div class="catlist">
				...
				<h2><?php echo $parentCats[0]['cat_name']; ?></h2>
				<div class="catlist_wrap">
					<!-- 循环顶级分类下面的二级分类,不能循环顶级分类,因为顶级分类只有一个 -->
					<!-- 当前分类只有一个顶级分类,面包屑导航第一个元素的cat_id即为当前顶级分类的cat_id -->
					<?php foreach( $children[ $parentCats[0]['cat_id'] ] as $two ) : ?>
					<div class="child">
						<h3 class="on"><b></b><?php echo $catsData[ $two ]['cat_name'] ?></h3>
						<ul>
							<?php foreach ($children[ $two ] as $three ) : ?>
							<li><a href="<?php echo url('/home/category/index', ['cat_id' => $three]); ?>"><?php echo $catsData[ $three ]['cat_name'] ?></a></li>
							<?php endforeach; ?>
						</ul>	
					</div>
					<?php endforeach; ?>
				...
				<ul>
					...
					<li>
						<dl>
							...
							<dd><strong>&yen; <?php echo $goods['goods_price'] ?></strong></dt>
