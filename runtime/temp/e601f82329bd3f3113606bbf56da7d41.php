<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"F:\www\local.shop\public/../application/admin\view\attribute\upd.html";i:1533195865;}*/ ?>
    ...
    <div class="formbody">
        ...
        <form action="" method="post">
            ...
            <ul class="forminfo">
                <li>
                    <label>属性名称</label>
                    <input name="attr_name" placeholder="请输入属性名称" type="text" class="dfinput" value="<?php echo $attr['attr_name']; ?>" /><i></i>
                </li>
                <li>
                    <label>商品类型</label>
                ...
                <li>
                    <label>属性值</label>
                    <textarea name="attr_values" cols="" rows="" class="textinput" /><?php echo $attr['attr_values']; ?></textarea>
                    <i>多个属性用|隔开</i>
                </li>
            </ul>
			<li>
