<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"F:\www\local.shop\public/../application/admin\view\goods\index.html";i:1533458159;}*/ ?>
        ...
        <table class="tablelist">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="/static/upload/<?php echo json_decode($good['goods_thumb'])[0]; ?>" alt="" /></td>
                    ...
                    <td><?php echo !empty($good['is_hot'])?'是' : '否'; ?></td>
                    <td><?php echo !empty($good['is_best'])?'是' : '否'; ?></td>
                    <td>
                        <a href="<?php echo url('admin/goods/upd', ['goods_id' => $good['goods_id']]); ?>" class="tablelink">编辑</a>
                        <a href="<?php echo url('admin/goods/del', ['attr_id' => $good['goods_id']]); ?>" onclick="return confirm('确认删除?')" class="tablelink"> 删除</a>
                    </td>
                </tr>
