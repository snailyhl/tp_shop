<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\www\local.shop\public/../application/admin\view\user\add.html";i:1533129781;}*/ ?>
    ...
    <div class="formbody">
        ...
        <form action="" method="post">
            <ul class="forminfo">
                ...
                <li>
                    <label>确认密码</label>
                    <input name="repassword" placeholder="请输入确认密码" type="text" class="dfinput" /><i></i>
                </li>            
            </ul>
			<li>
                <label>&nbsp;</label>
