<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"F:\www\local.shop\public/../application/admin\view\auth\index.html";i:1533139188;}*/ ?>
...
<body>
    <div class="place">
        ...
        <ul class="placeul">
            <li><a href="#">首页</a></li>
            <li><a href="#">数据表</a></li>
            <li><a href="<?php echo url('admin/auth/add'); ?>">添加权限</a></li>
        </ul>
    </div>
    <div class="rightinfo">
        <div class="tools">
        ...
        <table class="tablelist">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo str_repeat('&nbsp;',$auth['level']*3); ?><?php echo $auth['auth_name']; ?></td>
