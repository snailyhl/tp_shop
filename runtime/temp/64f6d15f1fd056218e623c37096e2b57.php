<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"F:\www\local.shop\public/../application/admin\view\index\top.html";i:1532955723;}*/ ?>
...
<body style="background:url(<?php echo config('admin_static'); ?>/images/topbg.gif) repeat-x;">
    ...
    <div class="topright">
        <ul>
            <li><a href="<?php echo url('admin/public/login'); ?>" onclick="return confirm('确认退出?')" target="_parent">退出</a></li>
        </ul>
        <div class="user">
