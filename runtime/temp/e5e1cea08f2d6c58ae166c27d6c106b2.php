<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"F:\www\local.shop\public/../application/admin\view\attribute\index.html";i:1533195055;}*/ ?>
        ...
        <table class="tablelist">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('admin/attribute/upd', ['attr_id' => $attr['attr_id']]); ?>" class="tablelink">编辑</a>
                        <a href="<?php echo url('admin/attribute/del', ['attr_id' => $attr['attr_id']]); ?>" onclick="return confirm('确认删除?')" class="tablelink"> 删除</a>
                    </td>
                </tr>
